...
////            val MonthText = view.findViewById<TextView>(R.id.exSevenMonthText)
...
//
//                DateText.setTextColor(view.context.getColorCompat(if (day.date == selectedDate) R.color.blue else R.color.gray))
